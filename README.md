...
# 📘 STUDY ELS  
### Learn English Smarter Every Day 🌍

<img src="https://img.shields.io/badge/Status-Building-orange" />
...
```bash
git clone https://github.com/SangTranTamLy/Study-ELS.git
cd Study-ELS
```
...
npm run dev
```
👉 Mở trình duyệt tại địa chỉ (Vite cung cấp):
http://localhost:5173/
...
---
## 📄 License
Dự án phục vụ **mục đích học tập, demo và cá nhân**.

Không sử dụng cho mục đích thương mại khi chưa có sự cho phép của tác giả.

Có thể tự do mở rộng và phát triển thêm cho học tập & nghiên cứu.
