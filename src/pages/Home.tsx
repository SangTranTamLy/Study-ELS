  ...
  return (
    <main className="home">
      ...
      <section className="home-hero">
        <h1>STUDY ELS</h1>
        <h3>Nền tảng học tiếng Anh thông minh</h3>
        <a href="https://git.io/typing-svg"><img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&pause=1000&width=435&lines=An+intelligent+English+learning+platform+tailored+for+students+and+independent+learners." alt="Typing SVG" /></a>
        <p>
